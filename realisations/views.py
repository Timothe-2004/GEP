...
from backend.permissions import IsAdminUser as CustomIsAdminUser, IsAdminOrReadOnly
...
@extend_schema_view(
    get=extend_schema(
        ...
        description="Récupère la liste de toutes les réalisations. Accessible à tous.",
    ),
    post=extend_schema(
        summary="Créer une réalisation",
        description="Crée une nouvelle réalisation. Réservé à l'administrateur.",
    ),
)
...
@extend_schema_view(
    get=extend_schema(
        ...
        description="Récupère les informations d'une réalisation. Accessible à tous.",
    ),
    put=extend_schema(
        summary="Mettre à jour une réalisation",
        description="Met à jour une réalisation existante. Réservé à l'administrateur.",
    ),
    patch=extend_schema(
        summary="Mise à jour partielle d'une réalisation",
        description="Met à jour partiellement une réalisation existante. Réservé à l'administrateur.",
    ),
    delete=extend_schema(
        summary="Supprimer une réalisation",
        description="Supprime une réalisation. Réservé à l'administrateur.",
    ),
)
